...
export const laziPostContractABI = [
  ...
  },
  {
    inputs: [
      ...
      { internalType: "string[]", name: "_laziPosts", type: "string[]" },
    ],
    name: "airdrop",
    outputs: [],
  ...
  {
    inputs: [
      { internalType: "string", name: "_laziPost", type: "string" },
      { internalType: "uint256", name: "_laziPostPrice", type: "uint256" },
      { internalType: "bytes32", name: "_signedMessageHash", type: "bytes32" },
  ...
  {
    inputs: [
      { internalType: "string", name: "_laziPostImages", type: "string" },
    ],
