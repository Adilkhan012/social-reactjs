...
//testnet
const engagementAddress = "0x2883B702f64078c49d282371342f1154AA8F3A2F";
// mainnet
...
const engagementABI = [
	...
	{
		"inputs": [],
		"name": "totalWeightedStakedDuration",
		"outputs": [
			{
				"internalType": "uint256",
				"name": "",
...
const initEngagementContract = async () => {
  ...
  return new Promise((resolve, reject) => {
    const engagementContract = new web3.eth.Contract(
      engagementABI,
      engagementAddress
    );
    resolve(engagementContract);
  });
};
